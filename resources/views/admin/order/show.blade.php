                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="text-primary">
                                ...
                                <a href="{{ url('admin/invoice/'.$order->id) }}" target="_blank"  class="btn btn-warning text-white btn-sm float-end mx-1">View Invoice</a>
                                <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}" class="btn btn-success text-white btn-sm float-end mx-1">Download Invoice</a>
                            </h4>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-5">
                                    <form action="{{ url('admin/order/'.$order->id) }}" method="POST">
                                        ...
                                        <div class="input-group">
                                            <select name="jancok" class="form-select">
